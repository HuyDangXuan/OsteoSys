  ...
  for (let i = 1; i <= 48; i++) {
    ...
    devices.push({
      ...
      calibration: {
        lastDate,
        nextDueDate,
        certifiedBy: "Kỹ sư Nguyễn Văn Tuấn",
        certificateNumber: `ISCD-QC-2026-${String(i + 1).padStart(3, "0")}`,
        iscdStandard: currentStatus !== "under_maintenance",
      ...
      accessories: ["Bóng dầu Silicone", "Khối chuẩn Phantom Hologic", "Dây nguồn AC", "Cáp in nhiệt"],
